...
class FunctionExtractor:
        ...
        try:
            ...
            for func_index, func_node in enumerate(functions):
                try:
                    ...
                    # Calculate score
                    score = self._calculate_function_score(func_code, clauses, len(var_indices))
                    ...
                    func_obj = ErlangFunction(
                        ...
                        score=score,
                        score_breakdown=self._calculate_score_breakdown(func_code, clauses, len(var_indices)),
                        repo_name=repo_name,
                        repo_path=repo_path
                    )
    ...
    def _calculate_function_score(self, code: str, clauses: List, num_vars: int) -> float:
    ...
    def _calculate_score_breakdown(self, code: str, clauses: List, num_vars: int) -> Dict[str, float]:
